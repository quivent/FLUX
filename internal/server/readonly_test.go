...
func TestReadOnlyGate(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/evening", true},
		{http.MethodGet, "/showcase", true},
		...
		{http.MethodGet, "/daemons", true},
		{http.MethodGet, "/api/tea/daemons", true},
		{http.MethodGet, "/api/tea/characters", true},
		{http.MethodGet, "/api/tea/law", true},
		{http.MethodGet, "/api/governor/models", true},
		{http.MethodGet, "/api/governor/health", true},
		...
		{http.MethodGet, "/garden", true},
		{http.MethodGet, "/engine", true},
		{http.MethodGet, "/discourse", true},
		{http.MethodGet, "/publications", true},
		{http.MethodGet, "/research", true},
		{http.MethodGet, "/api/jury/presets", true},
		{http.MethodPost, "/api/jury/presets", false},
		{http.MethodGet, "/reports", true},
		{http.MethodGet, "/api/reports", true},
		{http.MethodGet, "/charters", true},
		{http.MethodGet, "/api/charters", true},
		{http.MethodGet, "/hive", true},
		{http.MethodGet, "/api/hive", true},
		{http.MethodGet, "/algorithm", true},
		{http.MethodGet, "/api/protocol", true},
		{http.MethodGet, "/api/optics", true},
		{http.MethodGet, "/api/drive", true},
		{http.MethodGet, "/train", true},
		{http.MethodGet, "/api/train", true},
		...
		{http.MethodGet, "/api/rig", true},
		{http.MethodGet, "/api/rig/ws", true},
		...
		{http.MethodPost, "/api/tea/characters", false},
