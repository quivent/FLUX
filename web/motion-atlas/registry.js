...
connectSocket("/api/assets/ws",event=>{const a=event.asset||{};if(diagnostic(event.job_id)||diagnostic(a.path))return;if(!assets.some(x=>x.id===a.id)){assets.unshift({...a,job_id:event.job_id});render()}});
